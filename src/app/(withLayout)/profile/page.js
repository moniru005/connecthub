...
import TotalLike from "@/components/TotalLike/TotalLike";
          ...
          <div className='p-8 bg-white shadow mt-24'>
            <div className='grid grid-cols-1 md:grid-cols-3'>
              <div className='grid grid-cols-3 text-center order-last md:order-first mt-20 md:mt-0'>
                {/* <div>
                <p className="font-bold text-gray-700 text-xl"> <TotalLike/> </p>
                <p className="text-gray-400">Like</p>
              </div> */}
                <div className="w-full text-center col-span-3 ">
                  <div className="font-bold text-gray-700 text-xl"> <PostFetch /></div>
